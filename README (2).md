...
Unlike a simulated experiment, this is real recorded data — with unequal group sizes, no controlled randomization, and outlier ads with very high impression counts, all of which a clean simulation wouldn't have to deal with.
